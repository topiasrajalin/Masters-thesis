...
for t=1:T-N
    ...
    low_vola_bound = round(active_count2 * 0.1);

    high_vola_bound = round((active_count2 * 0.1) * 9);
    ...
    momentum_low_bound = round(active_count2 * 0.1);

    momentum_upp_bound = round((active_count2 * 0.1) * 9);
